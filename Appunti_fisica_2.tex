    ...
    \chapter{Elettrostatica nel vuoto}
        ...
        \section{Forza di Coulomb e campo elettrostatico}
            ...
            \begin{tikzpicture}
                ...
                \draw (0.1,1.8) .. controls (0.4,0.7) and (1,0.3) .. (2.8,0.2) node[anchor=south] {$\alpha\frac{1}{r^2}$};
    ...
    \section{Elettrostatica}
        \subsection{Superficie sferica con distribuzione superficiale}
            \begin{wrapfigure}[6]{r}{5cm}
                ...
                \draw [gray] (0,0) -- (1.05,1.05) node[midway, above] {R};
                \draw [gray] (0.8,-1.4) node[anchor=north] {$q=10^{-9}C$};
                \end{tikzpicture}
            \end{wrapfigure}
